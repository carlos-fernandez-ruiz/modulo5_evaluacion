...
class TrainingResult:
    """Resultado mínimo para evaluación en notebooks y futura persistencia vía API."""
...
def validate_options(model_name, variant):
    ...
    if variant not in VARIANTS:
        raise ValueError(f"Unknown variant '{variant}'. Available variants: {list(VARIANTS)}")
